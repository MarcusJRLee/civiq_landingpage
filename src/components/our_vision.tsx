  ...
  return (
    <section className="py-20 md:py-28 bg-white">
      <div className="container mx-auto px-6 text-center max-w-3xl">
        ...
        <ul className="mt-8 space-y-6 text-lg text-slate-700 text-left md:text-center leading-relaxed">
          <li>
            Projects Get Done{" "}
          ...
          <li>
            ...
            <p className="mt-1 text-slate-600">
              ...
              frustrating cycle of only choosing between &apos;mid
              candidates&apos; every few years.
            </p>
          </li>
          <li>
